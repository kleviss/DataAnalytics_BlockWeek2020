...
#Load Data
## Training and testing Data URL and Loading data to memory
...
#Cleaning Data
##Part 1 : CLeanin the non zero variance
...
```
#Part 2 : Removing the Dataset ID

```{r}
myTraining <- myTraining[c(-1)]
```

#Part 3 : Cleaning NA values
```{r}
...
submissionPredicitionDecisionTrees <- data.frame(Id = 1:length(predictionsB2), predictionsB2)
write.csv(submissionGBM, file = "PredicitionDecisionTrees.csv", row.names = F)

submissionPredicitionDecisionTrees <- data.frame(Id = 1:length(predictionsA1), predictionsA1)
write.csv(submissionGBM, file = "PredicitionRandomForests.csv", row.names = F)
